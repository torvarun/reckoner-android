...
public class API {
   ...
   */
  public static ArrayList<Article> getArticles(int page, String category)
      throws JSONException, IOException, InterruptedException, ExecutionException {
    String resp = new GetArticles().execute(URL + page + PARAM_CATEGORY + category)
        .get(); //Make the call synchronously
   ...
   * @throws ExecutionException
   */
  public static ArrayList<Article> getArticles(int page, String category, int numPosts)
      throws JSONException, IOException, InterruptedException, ExecutionException {
    String resp = new GetArticles().execute(
        URL + page + PARAM_CATEGORY + category + PARAM_POST_LIMIT + numPosts)
        .get(); //Make the call synchronously
